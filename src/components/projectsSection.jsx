...
const ProjectsSection = () => {
  return (
    <div className='-z-20  h-screen bg-[color:var(--primary-color)] relative bg-projects-background bg-contain bg-no-repeat bg-bottom flex justify-center items-center'>
